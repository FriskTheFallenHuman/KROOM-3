...
==============
*/
void idCinematicRoQ::InitCinematic()
{
	...
	file = ( byte* )Mem_Alloc( 65536, TAG_ROQ );
	vq2 = ( word* )Mem_Alloc( 256 * 16 * 4 * sizeof( word ), TAG_ROQ );
	vq4 = ( word* )Mem_Alloc( 256 * 64 * 4 * sizeof( word ), TAG_ROQ );
	vq8 = ( word* )Mem_Alloc( 256 * 256 * 4 * sizeof( word ), TAG_ROQ );
}
...
==============
*/
void idCinematicRoQ::ShutdownCinematic()
{
	Mem_Free( file );
	file = NULL;
	Mem_Free( vq2 );
...
idCinematicRoQ::idCinematicRoQ()
{
	...
	qStatus[0] = ( byte** )Mem_Alloc( 32768 * sizeof( byte* ), TAG_ROQ );
	qStatus[1] = ( byte** )Mem_Alloc( 32768 * sizeof( byte* ), TAG_ROQ );
}
...
==============
*/
int idCinematicRoQ::AnimationLength()
{
...
==============
*/
int idCinematicRoQ::GetStartTime()
{
	return startTime;
}
...
==============
*/
void idCinematicRoQ::move8_32( byte* src, byte* dst, int spl )
{
#if 1
	int* dsrc, *ddst;
	int dspl;
...
==============
*/
void idCinematicRoQ::move4_32( byte* src, byte* dst, int spl )
{
#if 1
	int* dsrc, *ddst;
	int dspl;
...
==============
*/
void idCinematicRoQ::blit8_32( byte* src, byte* dst, int spl )
{
#if 1
	int* dsrc, *ddst;
	int dspl;
...
==============
*/
void idCinematicRoQ::blit4_32( byte* src, byte* dst, int spl )
{
#if 1
	int* dsrc, *ddst;
	int dspl;
...
==============
*/
void idCinematicRoQ::blit2_32( byte* src, byte* dst, int spl )
{
#if 1
	int* dsrc, *ddst;
	int dspl;
...
==============
*/
unsigned short idCinematicRoQ::yuv_to_rgb( int y, int u, int v )
{
...
==============
*/
unsigned int idCinematicRoQ::yuv_to_rgb24( int y, int u, int v )
{
	int r, g, b, YY = ( int )( ROQ_YY_tab[( y )] );
...
void idCinematicRoQ::readQuadInfo( byte* qData )
{
	...
	if( !image )
	{
		image = ( byte* )Mem_Alloc( CIN_WIDTH * CIN_HEIGHT * samplesPerPixel * 2, TAG_ROQ );
	}
...
//
	if( RoQPlayed >= ROQSize || status == FMV_EOF )
	{
		if( looping )
		{
			RoQReset();
...
/*
==============
idCinematicRoQ::RoQ_init
==============
*/
void idCinematicRoQ::RoQ_init( void )
{
...
==============
*/
void idCinematicRoQ::RoQShutdown( void )
{
	status = FMV_EOF;
