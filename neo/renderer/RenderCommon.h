...
public:
	...
	virtual void			CropRenderSize( int width, int height, bool oldStyle = false );
...
extern idCVar r_skipVideo;					// skip Cinematic video decoding
...
extern idCVar r_shadowMapPolygonClamp;
