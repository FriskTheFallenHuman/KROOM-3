...
/*
==============
idCinematicBink::InitFromBinkDecFile
==============
*/
bool idCinematicBink::InitFromBinkDecFile( const char* qpath, bool amilooping )
{
	looping = amilooping;
	startTime = 0;
...
{
	animationLength = 0;
	return InitFromBinkDecFile( qpath, amilooping );
}
...
==============
*/
cinData_t idCinematicBink::ImageForTime( int thisTime )
{
...
/*
==============
idCinematicBink::ImageForTimeBinkDec
==============
*/
cinData_t idCinematicBink::ImageForTimeBinkDec( int thisTime )
{
	cinData_t	cinData;
