...
// set normal frame size
		...
		if( token.Icmp( "input" ) == 0 )
		{
			...
			range = ( int* )Mem_ClearedAlloc( num_files * sizeof( int ), TAG_ROQ );
			padding = ( bool* )Mem_ClearedAlloc( num_files * sizeof( bool ), TAG_ROQ );
			padding2 = ( bool* )Mem_ClearedAlloc( num_files * sizeof( bool ), TAG_ROQ );
			skipnum = ( int* )Mem_ClearedAlloc( num_files * sizeof( int ), TAG_ROQ );
			skipnum2 = ( int* )Mem_ClearedAlloc( num_files * sizeof( int ), TAG_ROQ );
			startnum = ( int* )Mem_ClearedAlloc( num_files * sizeof( int ), TAG_ROQ );
			startnum2 = ( int* )Mem_ClearedAlloc( num_files * sizeof( int ), TAG_ROQ );
			endnum = ( int* )Mem_ClearedAlloc( num_files * sizeof( int ), TAG_ROQ );
			endnum2 = ( int* )Mem_ClearedAlloc( num_files * sizeof( int ), TAG_ROQ );
			numpadding = ( int* )Mem_ClearedAlloc( num_files * sizeof( int ), TAG_ROQ );
			numpadding2 = ( int* )Mem_ClearedAlloc( num_files * sizeof( int ), TAG_ROQ );
			numfiles = ( int* )Mem_ClearedAlloc( num_files * sizeof( int ), TAG_ROQ );
			idStr empty;
