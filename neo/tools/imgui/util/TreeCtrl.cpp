...
class SortTreeNodeByLabel : public idSort_Quick< TreeNode*, SortTreeNodeByLabel >
{
public:
	int Compare( TreeNode* const& a, TreeNode* const& b ) const
	{
...
void TreeCtrl::SortChildren( TreeNode* item )
{
	...
	list.SortWithTemplate( SortTreeNodeByLabel() );
