...
#ifndef __MATERIALMODIFIER_H__
#define __MATERIALMODIFIER_H__
...
{
public:
	AddMaterialFolderModifier( MaterialDocManager* manager, const char* materialName, MaterialTreeView* view, wxTreeItemId item, wxTreeItemId parent );
...
{
public:
	RenameMaterialFolderModifier( MaterialDocManager* manager, const char* materialName, MaterialTreeView* view, wxTreeItemId item, const char* oldName );
...
{
public:
	DeleteMaterialFolderModifier( MaterialDocManager* manager, const char* materialName, MaterialTreeView* view, wxTreeItemId parent, idStrList* affectedMaterials );
