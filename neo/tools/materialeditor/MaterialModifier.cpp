...
*/
AddMaterialFolderModifier::AddMaterialFolderModifier( MaterialDocManager* manager, const char* materialName, MaterialTreeView* view, wxTreeItemId item, wxTreeItemId parent )
	: MaterialModifier( manager, materialName )
{
	this->view = view;
	this->item = item;
...
*/
RenameMaterialFolderModifier::RenameMaterialFolderModifier( MaterialDocManager* manager, const char* materialName, MaterialTreeView* view, wxTreeItemId item, const char* oldName )
	: MaterialModifier( manager, materialName )
{
	this->view = view;
	this->item = item;
...
*/
DeleteMaterialFolderModifier::DeleteMaterialFolderModifier( MaterialDocManager* manager, const char* materialName, MaterialTreeView* view, wxTreeItemId parent, idStrList* affectedMaterials )
	: MaterialModifier( manager, materialName )
{
	this->view = view;
	this->parent = parent;
