...
$ASTYLE_BIN -v --formatted --options=astyle-options.ini --exclude="extern" --recursive "*.h"
$ASTYLE_BIN -v --formatted --options=astyle-options.ini --exclude="extern" --exclude="d3xp/gamesys/SysCvar.cpp" --exclude="d3xp/gamesys/Callbacks.cpp" --recursive "*.cpp"
$ASTYLE_BIN -v --formatted --options=astyle-options.ini --recursive "../base/renderprogs/*.hlsl"
