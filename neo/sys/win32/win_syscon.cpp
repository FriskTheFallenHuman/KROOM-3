...
void Sys_CreateConsole()
{
	...
	wc.hIcon         = LoadIcon( GetApplicationInstance(), MAKEINTRESOURCE( IDI_ICON1 ) );
	...
	//s_wcd.hbmLogo = LoadBitmap( GetApplicationInstance(), MAKEINTRESOURCE( IDB_BITMAP_LOGO) );
